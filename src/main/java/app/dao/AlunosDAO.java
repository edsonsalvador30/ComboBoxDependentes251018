...
public interface AlunosDAO extends JpaRepository<Alunos, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity FROM Alunos entity WHERE entity.escola.id = :id")
  public Page<Alunos> findAlunossByEscola(@Param(value="id") java.lang.String id, Pageable pageable);
